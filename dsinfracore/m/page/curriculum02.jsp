...
<%@ include file="../inc/global_header.jsp" %>
	...
	<div class="container">
		<ul class="tab-menu02">
			...
			<li class="active"><a href="#">완료과정<span>2</span></a></li>
				...
				<li>
					...
					<div class="list-cont">
						...
						<div class="tbl-col">
							...
							<div>
								<div class="tbl-row01">
									<div><button type="btn-blgry" class="btn-gry btn-size05" disabled>미수료</button></div>
									<div><button type="button" class="btn-blgry btn-size05" disabled>학습완료</button></div>
								</div>
							</div>
						</div>
					</div>
