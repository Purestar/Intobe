...
<%@ include file="../inc/global_header.jsp" %>
	...
	<div class="container">
		<ul class="tab-menu02">
			<li><a href="#">시청중<span>5</span></a></li>
			<li><a href="#">시청완료<span>2</span></a></li>
			<li class="active"><a href="#">스크랩<span>20</span></a></li>
			<li><a href="#">좋아요<span>20</span></a></li>
		</ul>
					...
					<a href="#">
						...
						<div class="tbl-col list-cont vt">
							...
							<div>
								...
								<p class="list-time">스크랩 일시 :<br>2021.01.05 18:52</p>
							</div>
						</div>
					</a>
				</li>
