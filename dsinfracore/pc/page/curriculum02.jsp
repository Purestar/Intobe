				...
				<ul class="list-area">
                    <li class="flexbox">
						<div class="contents_info flexbox">
							...
							<span class="thumb"><img src="http://placehold.it/540x335" alt=""></span>
							<div>
                                <span class="badge-02-borg">온라인</span>
                                <p class="category">교육분류 대<i class="icon-rl"></i>교육분류 중<i class="icon-rl"></i>교육분류 소</p>
						...
						<div class="contents_status mb0 w185">
							<p class="btn-mini btn-bwh" >수료</p>
							<button class="btn-borg btn-size01">입장하기</button>
						</div>
					</li>
                    <li class="flexbox">
						<div class="contents_info flexbox">
						...
						<div class="contents_status mb0 w185">
							<p class="btn-mini btn-dgray" >미수료</p>
							<button class="btn-borg btn-size01" disabled>학습완료</button>
						</div>
					</li>
                    <li class="flexbox">
						<div class="contents_info flexbox">
