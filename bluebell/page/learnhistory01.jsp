...
<div class="sub-layout ">
	...
	<div class="inner sub-inner">
		<div class="contents">
			<div class="brd-wrap ">
                <ul class="tab-menu01">
                    <li class="active"><a href="#">시청중 콘텐츠 3</a></li>
                    <li><button type="button">완료한 콘텐츠 8</button></li>
                    <li><button type="button"> 스크랩한 콘텐츠 8</button></li>
                    <li><button type="button">좋아요 콘텐츠 8</button></li>
                </ul>
				<div class="brd-top ">
					<div class="fx-aic fx-gap-40">
						<button class="btn-lgry btn-sz02">시청 목록 삭제하기</button>
                    </div>
					<div class="">
						<ul class="vbar-01">
							<li><button class="on">최근 시청순</button></li>
							<li><button>과거 시청순</button></li>
							<li><button> 시청 진도율순</button></li>
						</ul>
					</div>
				</div>
                <ul class="brd-lst01-01" data-repeat="list">
                    <li>	
                        <div class="thumb-01">		
                            <div class="form-chk">
								<label class="chk"><input type="checkbox" id="listitem"><span></span><em class="boder2"></em></label>
							</div>
