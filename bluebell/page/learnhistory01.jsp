	...
	<div class="layout-inner">
		<div class="tab-wrap tab-scroll-menu" style="--m-pos: sticky; --m-top: var(--init-header-height); --m-z-idx: 10;">
			<ul class="tab-menu-01">
				<li class="active"><a href="#">시청중 <span class="pc">콘텐츠</span> 3</a></li>
				<li><a href="#"><span class="mobile-inline">시청완료</span> <span class="pc">완료한 콘텐츠</span> 8</a></li>
				<li><a href="#">스크랩<span class="pc">한 콘텐츠</span> 8</a></li>
				<li><a href="#">좋아요 <span class="pc">콘텐츠</span> 8</a></li>
			</ul>
		</div>
				...
				<ul class="mark-v-bar-01">
					<li>
						<div class="form-slt-btn-tran">
							...
							<label for="93c7lted8z" class="part-slt-txt">최근 시청순</label>
						</div>
					</li>
					<li>
						<div class="form-slt-btn-tran">
							<input id="emgulu5en5s" type="radio" name="boardFlt">
							<label for="emgulu5en5s" class="part-slt-txt">과거 시청순</label>
						</div>
					</li>
					<li>
						<div class="form-slt-btn-tran">
							<input id="z7r4puastvn" type="radio" name="boardFlt">
							<label for="z7r4puastvn" class="part-slt-txt">시청 진도율순</label>
						</div>
					</li>
				</ul>
			</div>
						...
						<div class="thumb-type-01-02">
							<span class="thumb-lt">
								<div class="form-slt-chk">
									<input id="iephxuvxvv" type="checkbox" name="" value="">
									<label for="iephxuvxvv" class="part-slt-txt"><span class="part-icon"></span></label>
								</div>
							</span>
