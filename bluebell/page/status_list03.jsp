	...
	<div class="layout-inner">
		...
		<div class="tab-wrap tab-equal tab-scroll-menu" style="--m-pos: sticky; --m-top: var(--init-header-height); --m-mg-t: 0; --m-z-idx: 10;">
			<ul class="tab-menu-01">
				...
				<li class="active"><a href="">완료과정 6</a></li>
				<li><a href="">평가 8</a></li>
				<li><a href="">설문 1</a></li>
			</ul>
		</div>
				...
				<li class="box-type-01" style="--dp: flex; --content-x: space-between; --items-y: center; --m-flex-d: column; --m-box-bd-r: 0;">
					...
					<div style="--dp: flex; --gap-x: 20px; --items-y: center; --m-w: 100%; --m-mg-t: 2.56vw;">
						<div class="pc" style="--w: 124px; --txt-a: center;">
							<p>미수료</p>
							<p style="--ft-c: #5f7ad5;">수료</p>
						</div>
						<div style="--dp: grid; --gap-y: 10px; --w: 124px; --m-w: 100%;">
							<button type="button" class="btn-type-b-blk" style="--btn-w: 100%;">처리사유</button>
							<button type="button" class="btn-type-b" style="--btn-w: 100%;">입장하기</button>
							<button type="button" class="btn-type-b-blk" disabled style="--btn-w: 100%;">학습완료</button>
						</div>
					</div>
				</li>
			</ul>
