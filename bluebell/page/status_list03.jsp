		...
		<div class="contents">
			<div class="tab-wrap" data-acting="">
				<ul class="tab-menu01-01">
					...
					<li class="active"><a href="../page/status_list03.jsp">완료과정 17</a></li>
            ...
            <div class="mt50">
                <div class="fx-gap-20">
                    ...
                    <label class="chk-rdo04">
                        <input type="checkbox" name=""><span>수료</span>
                    </label>
                    <label class="chk-rdo04">
                        <input type="checkbox" name=""><span>미수료</span>
                    </label>
                </div>
                <div class="brd-lst01-02 box-type-b-gry fx-aic fx-jcsb">
					...
					<div class="fx-aic fx-gap-20 fx-fdc">
                        <div class="fx-aic fx-gap-10">
                            <span class="-fblk"><!--수료마감--></span>
                            <button type="button" class="btn-b-blk">처리사유</button>
                        </div>
                        <div class="fx-aic fx-gap-10">
                            <span class="-fblk">미수료</span>
                            <button type="button" class="btn-b-red">입장하기</button>
                        </div>
					</div>
                </div>
                <div class="brd-lst01-02 box-type-b-gry fx-aic fx-jcsb">
					...
					<div class="fx-aic fx-gap-20">
                        <span class="-fblu">수료</span>
						<button type="button" class="btn-b-blk" disabled>학습완료</button>
					</div>
                </div>
                <div class="brd-lst01-02 box-type-b-gry fx-aic fx-jcsb">
                    <div class="fx-aic">
