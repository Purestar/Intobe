	...
	<div class="inner sub-inner">
		<div class="contents">
			<ul class="tab-menu01">
				...
				<li class="active"><button type="button">완료과정 8</button></li>
			</ul>
            
            <div class="mt50">
                <div class="brd-top ">
					<div class="fx-jcfe ">
						<button type="button" class="btn-sz02">사외교육 개설 신청</button>
                    </div>
				</div>
                <div class="brd-lst01-02 box-type-b-gry fx-aic fx-jcsb">
                    <div class="fx-aic">
                        <div class="list-cont-wrap">
                            ...
                            <div class="vbar-01">
                                <span>교육일수/시간 &nbsp;<b>1시간</b></span>
                                <span>인정시간 &nbsp;<b>2일</b></span>
                                <span>교육비&nbsp;<b>0</b></span>
                                <span>교육기관 <b>ST Invictus</b></span>
                            </div>
                            <div class="vbar-01">
                                <span>교육기간 <b> 2021.05.30 - 2021.06.10</b></span>
                            </div>
                            <p class="list-term mt10"><b></b></p>
                        </div>
                    </div>
					<div class="fx-aic fx-gap-20">
						<span class="-fgry">대기</span>
                        <div class="fx-gap-10 fx-fdc">
                            <button type="button" class="btn-b-blk">결과보고 수정</button>
                        </div>
					</div>
                </div>
                <div class="brd-lst01-02 box-type-b-gry fx-aic fx-jcsb">
					...
					<div class="fx-aic fx-gap-20">
						<span class="-fblu">결과보고 승인완료</span>
                        <div class="fx-gap-10 fx-fdc">
                            <button type="button" class="btn-b-blk">결과 보고서 보기</button>
                        </div>
					</div>
                </div>
                <div class="brd-lst01-02 box-type-b-gry fx-aic fx-jcsb">
					...
					<div class="fx-aic fx-gap-20">
						<span class="-fgry">대기</span>
                        <div class="fx-gap-10 fx-fdc">
                            <button type="button" class="btn-b-blk">결과보고</button>
                        </div>
					</div>
                </div>
                <div class="brd-lst01-02 box-type-b-gry fx-aic fx-jcsb">
