...
<div id="container">
	<div class="contents" style="--dp: flex; --fx-d: column;">
		...
		<div class="seat-map" style="--w-unit: 100%;">
			<div style="--dp: grid; --grid-t-col: 2; --w-unit: 100%; --gap-x: 10;">
				<p class="seat-blackboard">칠판</p>
				<p class="seat-blackboard">칠판</p>
			</div>
			<div style="--dp: grid; --grid-t-col: 2; --w-unit: 100%;">
				<!-- 링크 -->
				<div style="--pos: relative; --dp: grid; --gap-y: 48; --mg-t: 50; --content-x: center;">
					<div class="seat-group">
						<div class="seat-group-chk">
							<div class="form-slt-btn-01">
								...
								<label for="vrwm1ii8ed9" class="part-slt-txt">C1</label>
							</div>
							<div class="form-slt-btn-01">
								<input id="vrwm1ii8ed9" type="checkbox" checked>
								<label for="vrwm1ii8ed9" class="part-slt-txt">C2</label>
							</div>
							<div class="form-slt-btn-01">
								<input id="vrwm1ii8ed9" type="checkbox" disabled>
								<label for="vrwm1ii8ed9" class="part-slt-txt">C3</label>
							</div>
						</div>
					</div>
					<div class="seat-group">
					...
					<div class="seat-group" style="--pos: absolute; --pos-t: 126; --pos-l: 27">
						<div class="seat-group-chk">
							<div class="form-slt-btn-01">
								<input id="vrwm1ii8ed9" type="checkbox" disabled>
					...
					<div class="seat-group" style="--pos: absolute; --pos-t: 286; --pos-l: 27">
						<div class="seat-group-chk">
							<div class="form-slt-btn-01">
								<input id="vrwm1ii8ed9" type="checkbox" disabled>
								<label for="vrwm1ii8ed9" class="part-slt-txt">C14</label>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="seat-door-wrap" style="--w-unit: 100%; --mg-t: 116;">
				<i class="seat-door-icon-01" style="--pos-b: 0; --pos-l: 186;"></i>
				<i class="seat-door-icon-02" style="--pos-b: 0; --pos-r: 186;"></i>
			</div>
		</div>
	</div>
</div>
