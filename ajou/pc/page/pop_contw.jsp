...
<div class="pop-type" data-ttatg="contW">
	<div class="pop-contain">
		<div class="pop-head"><h1>콘텐츠 / 모듈 선택</h1></div>
		<div class="pop-cont">
			<div class="pop-cont-in">
                ...
                <div class="brd-wrap mt40 ">
					<div class="fx-jcsb">
						...
						<ul class="brd-ft">
							<li class="active"><a href="#">이름순</a></li>
							<li><a href="#">최신순</a></li>
							<li><a href="#">조회순</a></li>
						</ul>
					</div>
                    <ul class="brd-lst03-02 mt20">
                        <li>
                            <div class="brd-cont">
                        ...
                        <li class="non-list">
                            콘텐츠 및 모듈을 조회해주세요.<br>조회한 콘텐츠를 추천할 수 있습니다.
                        </li>
                    </ul>
