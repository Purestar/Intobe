...
<div class="sub-layout -lgry">
	<div class="inner sub-inner">
		<div class="contents">
			...
			<ul class="tab-menu01">
				<li><a href="#">학습중 콘텐츠</a></li>
				<li><a href="#">학습완료 콘텐츠</a></li>
				<li><a href="#">학습중모듈 </a></li>
				<li><a href="#">학습완료 모듈</a></li>
				<li><a href="#">학습중 MOOC</a></li>
				<li class="active"><a href="#">학습완료 MOOC</a></li>
			</ul>
			<div class="brd-wrap mt90">
				<div class="brd-form">
					<div><p class="txt-ic-impo">수료증 발급은 MOOC > 수료완료 강좌 메뉴에서 이용하실 수 있습니다.</p></div>
					<div>
						<ul class="brd-ft">
							<li class="active"><a href="#">학습완료 최근순</a></li>
							<li><a href="#">미처리순</a></li>
							<li><a href="#">미수료순</a></li>
						</ul>
					</div>
...
<script>
	...
	var notiLst = '';
		...
		notiLst += '<li>';
		notiLst += '	<div class="brd-cont fx-aic  w100">';
		...
		notiLst += '				        <span class="grp-horbar" style="width:100%;">';
		notiLst += '				            <span class="grp-horbar-num"><b>100</b>%</span>';
		notiLst += '				        </span>';
		notiLst += '				    </span>';
		notiLst += '			    </div>';
		notiLst += '			</div>';
		notiLst += '		</div>';
		notiLst += '	</div>';
        notiLst += '	<div class="brd-stat fx-jcc fx-aic">';
        notiLst += '		<b class="fc-pnk">미처리</b>';
        notiLst += '		<b class="fc-blu">수료</b>';
        notiLst += '		<b>미수료</b>';
        notiLst += '	</div>';
		notiLst += '</li>';
	$("[id*='notiLst']").contRpt(notiLst, 4);
</script>
