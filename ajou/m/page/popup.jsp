...
<div class="sub-layout">
	<div class="inner sub-inner">
		<div class="contents">
			...
			<button type="button" class="btn-lgry" data-tta="join">일반 회원가입</button>
			...
			<button type="button" class="btn-" data-tta="contslt">콘텐츠 구성</button>
			...
			<button type="button" class="btn-" data-tta="exam">시험 응시</button>
			<button type="button" class="btn-" data-tta="examanswer">답안보기</button>
			...
			<button type="button" class="btn-lgry" data-tta="completion">나의 학습이력</button>
...
<%@ include file="pop_examanswer.jsp" %> <!-- 콘텐츠 구성 -->
