...
<div class="main-page">
	<div class="inner main-cont01">
		<h1 class="main-logo"><img src="../images/img/img_logo.png"></h1>
		<div class="swi-type01 swi-ui-type01 main-slide">
			<div class="swiper">
				<div class="swiper-wrapper">
					<div class="swiper-slide main-slide01">
						...
						<div class="swiper-cont">
							<p>추천 콘텐츠 찾아보기</p>
							<p class="tit-01 mt24">최근 무엇에<br>관심 있으세요?</p>
						</div>
					</div>
					<div class="swiper-slide main-slide01">
		...
		<div class="main-top">
			<div class="main-notice fx-aic mt40 fx-gap-05">
				<h2 class="tit-07"><b>공지사항</b></h2>
				<div class="main-notice-swiper swi-type05 swi-ui-type03">
					<div class="swiper">
						<div class="swiper-wrapper">
	...
	<div class="inner main-cont03">
		<div class="fx-gap-02">
			<h2 class="tit-06">관심주제</h2>
			<button type="button"><i class="ic-set"></i></button>
		</div>
		<ul class="lst-favor scr-hor">
			<li><a href="#">수학</a></li>
			<li><a href="#">생명과학</a></li>
			<li><a href="#">행정학</a></li>
			<li><a href="#">일본어</a></li>
	...
	<div class="main-cont02 -lgry">
		<div class="inner">
			<h2 class="tit-06">에디터 추천 콘텐츠를 만나보세요.</h2>
			<div class="swi-type04 swi-ui-type02 brd-wrap">
				<div class="swiper">
					<ul id="mainRecomLst" class="swiper-wrapper brd-lst01"></ul>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="main-cont02">
		<div class="inner">
			<h2 class="tit-06">intobetutor님이 시청중인 콘텐츠 <strong class="fc-gry">95</strong></h2>
	...
	<div class="main-cont02 -lgry">
		<div class="inner">
			<h2 class="tit-06">따끈따끈 신규 콘텐츠 <strong class="fc-gry">20</strong></h2>
			<div class="swi-type02 swi-ui-type02 brd-wrap">
				<div class="swiper">
	...
	<div class="main-cont02">
		<div class="inner">
			<h2 class="tit-06">사용자들에게 관심도 높은 모듈 <strong class="fc-gry">95</strong></h2>
			<div class="swi-type02 swi-ui-type02 brd-wrap">
				<div class="swiper">
	...
	<div class="main-cont02 -lgry">
		<div class="inner">
			<h2 class="tit-06">intobetutor님 관심 주제에 따른 맞춤 추천 콘텐츠 <strong class="fc-gry">156</strong></h2>
			<div class="swi-type02 swi-ui-type02 brd-wrap">
				<div class="swiper">
...
<script>
	...
	var noticeLst = '';
		...
		noticeLst += '<li>';
		noticeLst += '	<h2 class="brd-tit"><a href="#">MOCA 사이트 업그레이드에 따른 일시중지안내</a></h2>';
		noticeLst += '	<p class="vbar-01 mt20">';
		noticeLst += '		<span class="fx-aic"><span class="bage-03-5-5 bage-03-sml"></span>intobetutor</span>';
		noticeLst += '		<span><b>조회수</b> 40</span>';
		noticeLst += '		<span><b>등록일</b> 2022-03-04</span>';
		noticeLst += '	</p>';
		noticeLst += '</li>';

	$("[id='noticeLst']").contRpt(noticeLst, 1);
	...
	var mainRecomLst = '';
		...
		mainRecomLst += '<li class="swiper-slide">';
		...
		mainRecomLst += '		<p class="brd-ctgr">영어</p>';
	...
	var playingLst = '';
		...
		playingLst += '		<p class="brd-ctgr">영어</p>';
		playingLst += '		<h3 class="brd-tit"><a href="#">[물리 1] 웹과제 3-4 : 원운동과 수직항력원운동과 수직항력원운동과 수직항력원운동과 수직항력원운동과 수직항력</a></h3>';
	...
	var newContLst = '';
		...
		newContLst += '		<div class="fx-gap-03">';
	...
	var usrFavorModuleLst = '';
		...
		usrFavorModuleLst += '		<div class="fx-gap-03">';
		usrFavorModuleLst += '			<span class="bage-08-org">역량 3</span>';
		usrFavorModuleLst += '			<span class="bage-08-bgrn">개방성</span>';
		usrFavorModuleLst += '			<span class="bage-08-red">역량 2</span>';
		usrFavorModuleLst += '		</div>';
	...
	var usrFavorRecomLst = '';
		...
		usrFavorRecomLst += '		<div class="fx-gap-03">';
		...
		usrFavorRecomLst += '		<a href="#">자세히보기</a>';
		usrFavorRecomLst += '	</div>';
		usrFavorRecomLst += '</li>';
