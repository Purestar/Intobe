...
<div class="sub-layout -lgry">
	<div class="inner sub-inner">
		<div class="contents">
			...
			<div class="brd-wrap">
				<p class="txt-ic-impo mt0">수료증 발급은 MOOC > 수료완료 강좌 메뉴에서 이용하실 수 있습니다.</p>
				<div class="brd-form mt20">
					<div class="sel-type01">
						<select name="" id="">
							<option value="">학습완료 최근순</option>
							<option value="">미처리순 </option>
							<option value="">미수료순 </option>
						</select>
					</div>
				</div>
...
<script>
	...
	var notiLst = '';
		...
		notiLst += '			</div>';
		notiLst += '		</div>';
        notiLst += '		<div class="brd-stat fx-jcc">';
