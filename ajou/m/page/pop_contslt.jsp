...
<div class="pop-type" data-ttatg="contslt">
	<div class="pop-contain">
		...
		<div class="pop-cont">
			<div class="pop-cont-in">
				...
				<div class="brd-wrap mt80">
					<p><b class="fc-blk">검색결과</b> <span class="fc-mnl">100</span><span class="fw-s">개 콘텐츠가 조회되었습니다.</span></p>
					<ul class="brd-lst03-02-full brd-lst-bdr mt20">
						<li>
							<div href="#" class="thumb-01">
		...
		<div class="pop-foot">
			<button type="button" class="btn-lgry" data-tta="contslt">취소</button>
