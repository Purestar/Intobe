...
$(function () {
	...
	$(".btn-ic-ct-top").topBtn(); // 탑버튼
	$("body").scrUI(); // 스크롤 관련 기능 모두 포함
...
$.fn.gnb = function () {
	...
	$obj.find(".h-gnb-bg").on("mouseleave", function () {
...
$.fn.swiperInit = function () {
	...
	$(".swi-type01").each(function () {
		...
		new Swiper(swiperTG.querySelector(".swiper"), {
			...
			pagination: {
				el: swiperTG.querySelector(".swiper-pagination"),
				type: 'fraction',
			},
		});
	});
